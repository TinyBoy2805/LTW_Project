    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
        {
            ...
            if(userId == null)
            {
                response.sendRedirect(request.getContextPath() + "/customer/pages/Contact.jsp");
                return;
            }
            ...
            request.getRequestDispatcher("/customer/pages/Contact.jsp").forward(request, response);
