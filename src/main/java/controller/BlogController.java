...
public class BlogController extends HttpServlet
{
    ...
    {
        //call service --> call DAO --> get BLOG
        //DAO --data--> service --data-->controller--page-->render
        ...
        request.getRequestDispatcher("/customer/pages/Blog.jsp").forward(request, response);
    }
