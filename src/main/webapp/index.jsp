    ...
    <div class="page-login">
        ...
        <main class="main-content">
            ...
            <div class="form-section">
                ...
                <form id="login-form" class="auth-form ${activeTab == 'register' ? 'auth-form--hidden' : 'auth-form--active'}" action="${pageContext.request.contextPath}/auth" method="post">
                    ...
                    <div class="input-group password-wrapper">
                        ...
                        <input type="password" id="login-password" name="input_password" placeholder=""
                ...
                <form id="register-form" class="auth-form  ${activeTab == 'register' ? 'auth-form--active' : 'auth-form--hidden'}" action="${pageContext.request.contextPath}/auth" method="post">
                    <!-- <h2 class="auth-form__title">Đăng ký tài khoản mới</h2> -->
                    <input type="hidden" name="action" value="register"/>
                    <div class="input-group">
                        <label for="reg-name" class="input-group__label">Tên người dùng</label>
